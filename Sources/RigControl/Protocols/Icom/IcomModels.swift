...
///     radio: .Icom.ic7600(),  // Uses default 0x7A
...
///     radio: .Icom.ic7600(),  // Address 0x7A (default)
///     connection: .serial(path: "/dev/ttyUSB0", baudRate: 19200)
/// )
///
/// // Second IC-7600 with custom address (user changed on radio to 0x7B)
/// let rig2 = RigController(
///     radio: .Icom.ic7600(civAddress: 0x7B),  // Custom address
...
extension RadioDefinition.Icom {
    ...
    public static func ic7600(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-7600",
    ...
    public static func ic7300(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-7300",
            defaultBaudRate: 115200,
    ...
    public static func ic7610(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-7610",
            defaultBaudRate: 115200,
    ...
    public static func ic7100(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-7100",
            defaultBaudRate: 19200,
    ...
    public static func ic705(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-705",
            defaultBaudRate: 19200,
    ...
    public static func ic703(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-703",
            defaultBaudRate: 19200,
    ...
    public static func ic706(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-706",
            defaultBaudRate: 19200,
    ...
    public static func ic706MKII(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-706MKII",
            defaultBaudRate: 19200,
    ...
    public static func ic706MKIIG(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-706MKIIG",
            defaultBaudRate: 19200,
    ...
    public static func ic7000(civAddress: UInt8? = nil) -> RadioDefinition {
        RadioDefinition(
            manufacturer: .icom,
            model: "IC-7000",
            defaultBaudRate: 19200,
