...
> `.Elecraft.k3`, `.Xiegu.g90`, `.Lab599.tx500`,
> `.Flex.flex6000`. Icom factories accept an optional CI-V address
> (`.Icom.ic7600(civAddress: 0x7B)`). If an example below still shows
> the pre-namespace flat form (`.icomIC9700`, `.yaesuFTDX10`), read
> it as the namespaced equivalent.
